...
class recentVC: UIViewController, UITableViewDataSource, UITableViewDelegate, ChooseUserDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("Cell", forIndexPath: indexPath) as! recentCell
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        performSegueWithIdentifier("recentChatSegue", sender: indexPath)
    }
    ...
    @IBAction func startNewMessageButtonClicked(sender: AnyObject) {
        performSegueWithIdentifier("recentChooseUserVC", sender: self)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "recentChooseUserVC" {
            let vc = segue.destinationViewController as! chooseUserVC
            vc.delegate = self
            
        }
        
        if segue.identifier == "recentChatSegue" {
