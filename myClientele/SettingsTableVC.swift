...
class SettingsTableVC: UITableViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    @IBAction func avatarSwitchChanged(switchState: UISwitch) {
        if switchState.on {
    ...
    //MARK: Tableview Delgate Functions
